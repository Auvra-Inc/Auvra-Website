    ...
    <section id='features' className='py-20 px-6 max-w-[1200px] mx-auto font-clash'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
        ...
        <motion.div
          ...
          className='w-full bg-white rounded-2xl p-8 md:p-10 border border-gray-200 shadow-sm flex flex-col h-full'
        >
        ...
        <motion.div
          ...
          className='w-full bg-black rounded-2xl p-8 md:p-10 text-white shadow-xl flex flex-col h-full border border-neutral-800'
        >
        ...
        <motion.div
          ...
          className='w-full bg-gradient-to-b from-[#F9F9F9] to-[#EBEBEB] rounded-2xl p-8 md:p-10 border border-gray-200 shadow-sm flex flex-col'
        >
          <div className='flex items-center justify-start gap-3 mb-4'>
        ...
        <motion.div
          ...
          className='w-full bg-gradient-to-b from-[#FDFDFD] to-[#EAEAEA] rounded-2xl p-8 md:p-10 border border-gray-200 shadow-sm flex flex-col'
        >
          <div className='flex items-center justify-start gap-3 mb-4'>
