  ...
  return (
    <section className="py-15 px-6 overflow-hidden bg-white font-clash">        
      ...
      <div className="relative max-w-5xl mx-auto h-[500px] sm:h-[600px] md:h-[700px] flex justify-center items-center mt-10">
        ...
        <div className="absolute left-[5%] sm:left-[8%] md:left-[8%] bottom-[15%] w-24 sm:w-32 md:w-40 h-24 sm:h-32 md:h-40 rounded-3xl shadow-2xl overflow-hidden z-10 animate-float-fast">
        ...
        <div className="absolute right-[2%] sm:right-[8%] md:right-[8%] bottom-[20%] w-16 sm:w-20 md:w-28 bg-white p-2 sm:p-3 md:p-4 rounded-3xl shadow-xl border border-gray-100 text-center z-10 animate-float-slow">
