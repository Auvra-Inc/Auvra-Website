        ...
        <div className="grid grid-cols-2 gap-y-10 gap-x-4 mb-16 relative z-20">
          ...
          <div className="flex flex-col gap-4 font-clash">
            ...
            <div className="flex items-center gap-3">
              <a href="https://instagram.com/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full  text-[#E1306C] flex items-center justify-center transition hover:bg-[#E1306C] hover:text-white">
                <FaInstagram className="w-5 h-5" />
              </a>
              <a href="https://twitter.com/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full  text-[#1DA1F2] flex items-center justify-center transition hover:bg-[#1DA1F2] hover:text-white">
                <FaTwitter className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full  text-[#0A66C2] flex items-center justify-center transition hover:bg-[#0A66C2] hover:text-white">
