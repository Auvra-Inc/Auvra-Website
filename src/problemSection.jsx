  ...
  return (
    ...
    <section className="py-16 md:py-24 px-6 max-w-5xl mx-auto bg-white font-clash">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-16 items-start md:items-center mb-10 md:mb-16 w-full">
        ...
        {/* Right Side: The text - UNESCO link to endangered languages page */}
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed font-clash text-justify md:text-left md:w-1/2">
          According to <a href="https://www.unesco.org/en/articles/multilingual-education-bet-preserve-indigenous-languages-and-justice" target="_blank" rel="noopener noreferrer" className="text-gray-700 no-underline hover:text-gray-900">UNESCO</a>, at least one language dies every two weeks. When a language vanishes, it takes with it:
        </p>
      </div>
