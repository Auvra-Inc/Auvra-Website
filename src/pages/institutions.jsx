  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white pt-32 pb-20">
        ...
        <div className="relative min-h-[80vh] flex items-center justify-center bg-black mb-16">
          ...
          <div className="relative z-20 max-w-4xl mx-auto text-center px-6">
            <motion.h1 
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-clash font-light text-white mb-6 tracking-tight"
            >
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-gray-300 font-light mb-8 max-w-2xl mx-auto"
            >
        ...
        {/* ONE INFRASTRUCTURE LAYER - White background */}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <motion.h2 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="text-3xl md:text-4xl font-clash font-light text-black mb-4"
              >
        ...
        {/* PERMANENT, IMMUTABLE RECORDS - Gray background */}
        ...
        {/* OPEN ACCESS BY DEFAULT - White background */}
        <section className="max-w-6xl mx-auto px-6 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <motion.h2 
        ...
        {/* COMMUNITY + INSTITUTIONAL VERIFICATION - Gray background */}
        <section className="bg-gray-50 py-20">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
        ...
        {/* BULK UPLOAD AT SCALE - White background */}
        <section className="max-w-6xl mx-auto px-6 py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <motion.h2 
        ...
        {/* API FOR EVERYTHING - Gray background */}
        <section className="bg-gray-50 py-20">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
        ...
        {/* 4 FEATURE CARDS - Like About page cards */}
        <section className="max-w-6xl mx-auto px-6 py-20">
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="text-3xl md:text-4xl font-clash font-light text-black text-center mb-12"
          >
            Preserve with confidence
          </motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gray-50 rounded-2xl p-6 text-center">
              <div className="mb-4 flex justify-center">{Icons.bulk}</div>
              <h3 className="text-lg font-medium text-black mb-1">Bulk upload</h3>
              <p className="text-gray-400 text-sm">Thousands of assets at once</p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-6 text-center">
              <div className="mb-4 flex justify-center">{Icons.blockchain}</div>
              <h3 className="text-lg font-medium text-black mb-1">Blockchain verified</h3>
              <p className="text-gray-400 text-sm">Tamper-proof provenance</p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-6 text-center">
              <div className="mb-4 flex justify-center">{Icons.open}</div>
              <h3 className="text-lg font-medium text-black mb-1">Open access</h3>
              <p className="text-gray-400 text-sm">Share with the world</p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-6 text-center">
              <div className="mb-4 flex justify-center">{Icons.api}</div>
              <h3 className="text-lg font-medium text-black mb-1">API access</h3>
              <p className="text-gray-400 text-sm">Connect your systems</p>
            </div>
          </div>
        </section>

        {/* TECHNICAL SPECS - Like About page cards */}
        <section className="bg-gray-50 py-20">
          <div className="max-w-6xl mx-auto px-6">
            <motion.h2 
              initial={{ opacity: 0, y: 20 }}
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white rounded-2xl p-6">
                <div className="mb-3">{Icons.blockchain}</div>
              ...
              <div className="bg-white rounded-2xl p-6">
                <div className="mb-3">{Icons.storage}</div>
              ...
              <div className="bg-white rounded-2xl p-6">
                <div className="mb-3">{Icons.open}</div>
              ...
              <div className="bg-white rounded-2xl p-6">
                <div className="mb-3">{Icons.api}</div>
              ...
              <div className="bg-white rounded-2xl p-6">
                <div className="mb-3">{Icons.verification}</div>
              ...
              <div className="bg-white rounded-2xl p-6">
                <div className="mb-3">{Icons.bulk}</div>
        ...
        {/* CONTROL SECTION - White background */}
        <section className="max-w-4xl mx-auto px-6 py-20 text-center">
          <motion.h2 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="text-3xl md:text-4xl font-clash font-light text-black mb-6"
          >
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.1 }}
            className="text-gray-500 font-light mb-4"
          >
        ...
        <section className="bg-gray-50 py-20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <motion.h2 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="text-2xl md:text-3xl font-clash font-light text-black mb-4"
            >
