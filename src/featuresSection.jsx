  ...
  return (
        ...
        ========================================= */}
                <div className='w-full'>
                    ...
                    {/* THIS IS THE FIX: Grid applied! 1 col on mobile, 2 cols on desktop */}
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8 w-full'>
                        
                        {/* --- THE LOOP STARTS HERE (3 CARDS) --- */}
                        ...
                        {/* Glassmorphism Quote Card (This naturally becomes the 4th card to complete the 2x2 grid!) */}
                        <div className='relative w-full rounded-[2rem] overflow-hidden shadow-2xl aspect-[4/5] sm:aspect-square flex items-center justify-center p-6'>
                            {/* Background Image */}
                            <img
                                src='/art3.png'
                                alt='Auvra Culture'
                    ...
                    {/* Download Buttons (Safely below the 2x2 grid) */}
