	...
	return (
        ...
        ========================================= */}
			<motion.div
				...
				className='bg-black rounded-[2rem] p-8 pt-4 text-white shadow-xl flex flex-col h-full border border-neutral-800 text-center md:text-left'
			>
...
<motion.div
				...
				className='w-full max-w-md bg-gradient-to-b from-[#F9F9F9] to-[#EBEBEB] rounded-[2.5rem] p-8  pt-4 md:p-10 border border-gray-200 shadow-sm flex flex-col'
			>
					{/* HEADER SECTION */}
...
========================================= */}
					<motion.div
						...
						className='bg-[#0f1d14] rounded-[2.5rem] p-8 pt-4 md:p-12 text-white shadow-xl lg:col-span-2 relative overflow-hidden flex flex-col md:flex-row gap-10 md:gap-16 items-center border border-green-900/50 hover:border-green-800 transition'>
					{/* Background Image */}
					<img
						src='/3img.jpg'
        ...
        ========================================= */}
					<motion.div
						...
						className='w-full max-w-md bg-gradient-to-b from-[#FDFDFD] to-[#EAEAEA] rounded-[2.5rem] p-8 pt-4 md:p-10 border border-gray-200 shadow-sm flex flex-col'>
					{/* HEADER SECTION */}
					<div className='flex items-center gap-3 mb-4'>
