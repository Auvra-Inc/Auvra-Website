  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        {/* HERO SECTION - With background image overlay (like "Be fully present") */}
        <div className="relative h-screen flex items-center justify-center bg-black">
          <div className="absolute inset-0 bg-black/50 z-10"></div>
          <div className="absolute inset-0 bg-gray-800">
            {/* Image space - add your hero image here */}
          </div>
        ...
        {/* SCROLL-TRIGGERED CARD STACK - Like Talksign XR */}
        <div ref={containerRef} className="relative bg-white">
          {/* Spacer before cards start */}
          ...
          <div className="sticky top-0 h-screen flex items-center overflow-hidden">
            <div className="max-w-6xl mx-auto px-6 w-full">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                {/* Right side - fixed card/image space */}
                <div className="aspect-square bg-gray-100 rounded-2xl overflow-hidden">
                  {/* Image space - stays in place while text changes */}
                </div>
              </div>
            </div>
          </div>
        ...
        {/* FEATURE GRID - 4 columns with light styling */}
        <div className="max-w-6xl mx-auto px-6 py-24">
          <h2 className="text-2xl md:text-3xl font-clash font-light text-black text-center mb-12">
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 border-t border-gray-100">
          ...
          <div className="grid md:grid-cols-2 gap-x-16 gap-y-8 max-w-3xl mx-auto">
            <div>
              ...
              <p className="text-gray-400 text-xs">Every record is immutable. No disputes.</p>
            </div>
            <div>
              <h3 className="font-medium text-black text-sm mb-1">Arweave storage</h3>
              <p className="text-gray-400 text-xs">Pay once. Store forever. No recurring fees.</p>
            </div>
            <div>
              <h3 className="font-medium text-black text-sm mb-1">Public registry</h3>
              <p className="text-gray-400 text-xs">Open access by default.</p>
            </div>
            <div>
              <h3 className="font-medium text-black text-sm mb-1">Institutional API</h3>
              <p className="text-gray-400 text-xs">Connect your existing systems.</p>
            </div>
            <div>
              <h3 className="font-medium text-black text-sm mb-1">Community verification</h3>
              <p className="text-gray-400 text-xs">Trust through consensus.</p>
            </div>
            <div>
              <h3 className="font-medium text-black text-sm mb-1">Bulk upload dashboard</h3>
              <p className="text-gray-400 text-xs">Preserve thousands of assets in minutes.</p>
            </div>
          </div>
        </div>
        ...
        {/* FINAL CTA */}
        <div className="max-w-4xl mx-auto px-6 py-16 text-center border-t border-gray-100">
          <h2 className="text-xl md:text-2xl font-clash font-light text-black mb-4">
