...
// Icon components for C.U.L.T.U.R.E. values - NO SHADOW
const Icons = {
  'Cultural Integrity.': (
...
// Icons for How We Achieve This - NO SHADOW
...
// Icons for Our Approach section - NO SHADOW
const ApproachIcons = {
  cocreated: (
    <div className="w-10 h-10 md:w-12 md:h-12 bg-white rounded-lg flex items-center justify-center">
      <svg className="w-5 h-5 md:w-6 md:h-6 text-black" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
...
export default function About() {
	...
	// Updated How We Achieve Data - Removed Fair Economics card
	...
	// Animation variants with color changing for How We Achieve cards
	const cardVariants = {
	...
	const colorCycleVariants = {
		...
		whileInView: {
			backgroundColor: ["#ffffff", "#1a3a5c", "#ffffff", "#0a0a0a", "#ffffff"],
			transition: {
				duration: 8,
				repeat: Infinity,
				ease: "easeInOut",
	...
	return (
		<div className='w-full bg-white pb-20'>
			...
			{/* 5. OUR APPROACH SECTION - Reduced top padding to bring closer */}
			<motion.section initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={sectionVariants} className='w-full bg-gray-50 pt-8 pb-16'>
				<div className='max-w-7xl mx-auto px-6 md:px-12'>
