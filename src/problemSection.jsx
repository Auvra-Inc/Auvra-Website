const ProblemSection = () => {
  return (
    <section className="py-15 mt-8 px-6 max-w-4xl mx-auto bg-white font-clash">
      {/* Headlines */}
      <h2 className="text-2xl md:text-5xl font-semibold tracking-tight text-gray-900 ">
        Culture is disappearing.
      </h2>
      <h3 className="text-2xl md:text-5xl font-semibold tracking-tight text-red-500 mb-12 ">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start mb-12">
        <div className="flex  items-center gap-8">
          <div className="text-7xl font-medium text-red-500 leading-none">40%</div>
      ...
      {/* Tags */}
      <div className="grid grid-cols-3  mb-6 font-clash">
      ...
      <div className="relative p-8 w-[350px] text-justify rounded-3xl  shadow-sm overflow-hidden bg-white/10 backdrop-blur-xl border border-white/20">
        ...
        <p className="relative z-10 text-md text-gray-800 leading-relaxed">
          ...
          <span className=" text-blue-700 font-medium">But lived</span>
        </p>
      </div>
    </section>
  );
