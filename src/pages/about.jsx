      ...
      <section className='w-full bg-white py-12 overflow-hidden'>
        <div className='mb-6 text-center px-6'>
          <motion.h2 
            ...
            className='text-2xl md:text-3xl font-clash font-medium text-black tracking-tight'
          >
          ...
          >
            ...
            <div className='relative w-[340px] md:w-[400px] flex-shrink-0 rounded-2xl overflow-hidden group cursor-pointer h-[240px]'>
              ...
              <div className="relative z-10 flex flex-col p-5 h-full justify-start pt-6">
                ...
                <h3 className="text-lg font-clash font-bold text-white mb-0.5">SDG 11</h3>
                <p className="text-xs text-white/90 mb-1">Sustainable Cities & Communities</p>
                <p className="text-[10px] italic text-white/80 mb-2 tracking-wide">Target 11.4: Protect and safeguard cultural and natural heritage</p>
            ...
            <div className='relative w-[340px] md:w-[400px] flex-shrink-0 rounded-2xl overflow-hidden group cursor-pointer h-[240px]'>
              ...
              <div className="relative z-10 flex flex-col p-5 h-full justify-start pt-6">
                ...
                <h3 className="text-lg font-clash font-bold text-white mb-0.5">SDG 8</h3>
                <p className="text-xs text-white/90 mb-1">Decent Work & Economic Growth</p>
                <p className="text-[10px] italic text-white/80 mb-2 tracking-wide">Target 8.3 & 8.5: Promote decent work for creative professionals</p>
            ...
            <div className='relative w-[340px] md:w-[400px] flex-shrink-0 rounded-2xl overflow-hidden group cursor-pointer h-[240px]'>
              ...
              <div className="relative z-10 flex flex-col p-5 h-full justify-start pt-6">
                ...
                <h3 className="text-lg font-clash font-bold text-white mb-0.5">SDG 10</h3>
                <p className="text-xs text-white/90 mb-1">Reduced Inequalities</p>
                <p className="text-[10px] italic text-white/80 mb-2 tracking-wide">Target 10.2: Promote social and economic inclusion of all</p>
