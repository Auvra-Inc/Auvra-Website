...
const faqs = [
	{
		...
		answer:
			'A badge is a permanently verifiable cultural record. It can be a piece of art, a family story, a traditional recipe, a language lesson, or a craft technique. Every badge is anchored on the blockchain, so it carries the context, provenance, and history of the people behind it, and the community that verified it.',
	},
	{
		question:
			"What's the difference between a Collectible Badge and a Contribution Badge?",
		answer: (
			<>
				A <strong>Collectible Badge</strong> is a record that is meant to be
				owned and collected. Like a limited edition artwork or piece of music,
				or a crafted object. It can be shared with the world and collected by
				people who value it.
				<br />
				<br />A <strong>Contribution Badge</strong> is for records that belong
				to everyone: languages, oral history, rituals, recipes, and more.
				Representation verified by the community that holds it, and available as
				a common record to all.
			</>
		),
	},
	{
		...
		answer:
			'Auvra relies on a decentralized network of community elders and verified cultural custodians to review and authenticate records before they are permanently minted.',
	},
	{
		question: 'Do I need to understand blockchain to use Auvra?',
		answer:
			'Not at all. Auvra handles all the complex web3 technology in the background. You can use it just like any other app.',
	},
	{
		question: 'Can institutions and communities use Auvra?',
		answer:
			'Yes, institutions, museums, and community organizations can create verified accounts to help catalog and preserve their specific cultural archives.',
	},
];
